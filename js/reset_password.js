...
const resetId = findGetParameter("resetId");
...
function resetPassword() {
    ...
    requestWithCsrf("php/resetPassword.php", "passwordFirst=" + passwordFirst + "&passwordSecond=" + passwordSecond + "&resetId=" + resetId, function(data) {
       if (data === "success") {
