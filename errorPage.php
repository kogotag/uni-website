...
<html>
    ...
    <body>
        ...
        <p>
            ...
            } else if ($message === "passwordResetTooManyAttempts") {
                echo "Слишком много попыток восстановления пароля с неверным кодом восстановления. Попробуйте на следующий день или обратитесь в поддержку.";
            }
            ?>
        </p>
