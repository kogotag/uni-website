...
<html>
    ...
    <body class="bg-light">
        ...
        <div class="container-fluid">
            <div class="row mb-2 mt-4">
                ...
                <div class="col-10 pl-1 pr-4">
                    ...
                    <textarea class="form-control mb-2" id="forumTopicNameArea" rows="1" placeholder="Введите название темы..."></textarea>
                    ...
                    <div class="btn btn-primary" id="forumButtonCreate">Создать тему</div>
                </div>
                <div class="col-1"></div>
            </div>
        ...
        <script src="/js/forumCreateTopic.js"></script>
    </body>
</html>